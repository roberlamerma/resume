...
\begin{itemize}
	...
	\langpt{\item Projetou e desenvolveu um \textbf{framework de software baseado em C{\#}} para aplicações internas de contabilidade e tributação, aumentando a eficiência operacional.}  
\end{itemize}
...
\begin{itemize}
	...
	\langpt{\item Projetou e desenvolveu serviços e aplicações .NET.}  
\end{itemize}
...
\begin{itemize}
	...
	\langpt{\item Projetou e desenvolveu software para loja de música online usando Perl, FastCGI, PostgreSQL e Objective-C.}  
...
\langen{\wheelchart{1.3cm}{0.4cm}{
	3/8em/Emphasis!90/Software Architecture,  
	2/8em/Emphasis!45/Linux expert,  
	2/8em/Emphasis!15/Artificial Intelligence, 
	2/8em/Emphasis/\mbox{C\# \& C++},  
	...
	3/8em/Emphasis!60/Embedded \mbox{Linux (ARM)}
 }}
\langpt{\wheelchart{1.3cm}{0.4cm}{
		3/8em/Emphasis!90/Arquitetura de software,  
		2/8em/Emphasis!45/Especialista em Linux,  
